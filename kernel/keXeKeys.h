...
//	XEKEYS_STATUS_UNKNOWN_00000020 = 0x00000020,
	...
	XEKEYS_STATUS_KEYVAULT_GAME_REGION_DEVKIT = 0x00001000,
...
#define XEKEYS_STATUS_FACTORY_READY \
	(XEKEYS_STATUS_KEYS_INITIALIZED | XEKEYS_STATUS_FACTORY_CHALLENGE_READY)
#define XEKEYS_STATUS_MANUFACTURING_POLICY \
	(XEKEYS_STATUS_MANUFACTURING_MODE | XEKEYS_STATUS_MANUFACTURING_IMAGE_MAPPING_POLICY)
#define XEKEYS_STATUS_SUPERDEV_CPU_KEY \
	(XEKEYS_STATUS_FUSE_STATE_INITIALIZED | XEKEYS_STATUS_SPECIAL_55_CPU_KEY)
#define XEKEYS_STATUS_CHECKED_DEFAULT \
	(XEKEYS_STATUS_DEVELOPMENT_POLICY_OVERRIDE | XEKEYS_STATUS_DEVICE_AUTHENTICATION_BYPASS | XEKEYS_STATUS_HARD_DISK_AUTHENTICATION_BYPASS)
#define XEKEYS_STATUS_RETAIL_BASE \
	(XEKEYS_STATUS_FUSE_STATE_INITIALIZED | XEKEYS_STATUS_KEYS_INITIALIZED | \
	 XEKEYS_STATUS_FLASH_KEYVAULT_LOADED | XEKEYS_STATUS_FACTORY_CHALLENGE_READY | \
	 XEKEYS_STATUS_KEYVAULT_COMPLETE | XEKEYS_STATUS_EXTENDED_KEYVAULT_INITIALIZED | \
	 XEKEYS_STATUS_DVD_NV_PAGE_VERIFIED | XEKEYS_STATUS_SECURITY_POLICY_GATE | \
	 XEKEYS_STATUS_SECURITY_SETTINGS_LOAD_ATTEMPTED | XEKEYS_STATUS_SECROM_DIGEST_VERIFIED | \
	 XEKEYS_STATUS_CURRENT_UPDATE_SEQUENCE_OBSERVED | XEKEYS_STATUS_DVD_AUTH_EX_LOAD_ATTEMPTED)
